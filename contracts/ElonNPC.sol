...
contract ElonNPC is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet =
        payable(0x231615B33930199B3B911d92De3246c0Eb301125);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityTokens = contractTokenBalance.mul(_liquidityFee).div(
            _liquidityFee.add(_marketingFee)
        );
    ...
    function setFeePercent(
        ...
        require(
            taxFee.add(liquidityFee).add(marketingFee).add(burnFee) <= 10,
            "tax too high"
        );
        _taxFee = taxFee;
